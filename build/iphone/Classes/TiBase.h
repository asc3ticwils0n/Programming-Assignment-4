...
// in simulator we redefine to format for ProgrammingAssignment4 Developer console
...
{\
	NSString * exceptionName = [@"org.programmingassignment4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.programmingassignment4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIProgrammingAssignment4NativeItemNone = -1, 
	UIProgrammingAssignment4NativeItemSpinner = -2,
	UIProgrammingAssignment4NativeItemProgressBar = -3,
	
	UIProgrammingAssignment4NativeItemSlider = -4,
	UIProgrammingAssignment4NativeItemSwitch = -5,
	UIProgrammingAssignment4NativeItemMultiButton = -6,
	UIProgrammingAssignment4NativeItemSegmented = -7,
	
	UIProgrammingAssignment4NativeItemTextView = -8,
	UIProgrammingAssignment4NativeItemTextField = -9,
	UIProgrammingAssignment4NativeItemSearchBar = -10,
	
	UIProgrammingAssignment4NativeItemPicker = -11,
	UIProgrammingAssignment4NativeItemDatePicker = -12,
	
	UIProgrammingAssignment4NativeItemInfoLight = -13,
	UIProgrammingAssignment4NativeItemInfoDark = -14,
	
	UIProgrammingAssignment4NativeItemDisclosure = -15,
	
	UIProgrammingAssignment4NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all ProgrammingAssignment4 instances of
