...
@interface ProgrammingAssignment4Object : KrollCoverageObject {
#else
@interface ProgrammingAssignment4Object : KrollObject {
#endif
@private
...
extern NSString * ProgrammingAssignment4$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	ProgrammingAssignment4Object *_programmingassignment4;
    KrollObject* console;
	BOOL shutdown;
