...
//Rare exceptions to indicate a bug in the _programmingassignment4 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for ProgrammingAssignment4 proxies.
 */
