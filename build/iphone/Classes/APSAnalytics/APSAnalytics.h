 ...
 * to send analytic data that can be viewed on the ProgrammingAssignment4 Dashboard.
 *
 * For information on getting started with ProgrammingAssignment4 Platform Services,
