...
//@interface ProgrammingAssignment4Object : NSObject
//@end

@interface ProgrammingAssignment4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ProgrammingAssignment4Object class]])
		{
			for (NSString *key in [[(ProgrammingAssignment4Object*)o modules] allKeys])
			{
