...
/**
 Base class for all ProgrammingAssignment4 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the ProgrammingAssignment4 view hierarchy (such as wrapped iOS UIViews) was touched.
